...
set_property PACKAGE_PIN U1 [get_ports {Cin0}] 	 	 	 	 	 
...
set_property PACKAGE_PIN N3 [get_ports {sum0}]  	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {sum0}] 
set_property PACKAGE_PIN P1 [get_ports {sum1}]  	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {sum1}] 
set_property PACKAGE_PIN L1 [get_ports {Cout1}]  	 	 	 	  			
